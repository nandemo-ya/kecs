...
func (r *Router) Route(w http.ResponseWriter, req *http.Request) {
	...
	case "CreateBucketMetadataConfiguration":
		r.handleCreateBucketMetadataConfiguration(w, req)
	...
	case "DeleteBucketMetadataConfiguration":
		r.handleDeleteBucketMetadataConfiguration(w, req)
	...
	case "GetBucketMetadataConfiguration":
		r.handleGetBucketMetadataConfiguration(w, req)
	...
	case "UpdateBucketMetadataInventoryTableConfiguration":
		r.handleUpdateBucketMetadataInventoryTableConfiguration(w, req)

	case "UpdateBucketMetadataJournalTableConfiguration":
		r.handleUpdateBucketMetadataJournalTableConfiguration(w, req)
...
// handleCreateBucketMetadataConfiguration handles the CreateBucketMetadataConfiguration operation
func (r *Router) handleCreateBucketMetadataConfiguration(w http.ResponseWriter, req *http.Request) {
	// Parse input
	var input CreateBucketMetadataConfigurationRequest
	if req.ContentLength > 0 {
		if err := json.NewDecoder(req.Body).Decode(&input); err != nil {
			writeError(w, http.StatusBadRequest, "InvalidParameterValue", fmt.Sprintf("Invalid JSON: %v", err))
			return
	...
	// Call API
	output, err := r.api.CreateBucketMetadataConfiguration(req.Context(), &input)
	if err != nil {
		writeAPIError(w, err)
		return
	}
...
// handleDeleteBucketMetadataConfiguration handles the DeleteBucketMetadataConfiguration operation
func (r *Router) handleDeleteBucketMetadataConfiguration(w http.ResponseWriter, req *http.Request) {
	// Parse input
	var input DeleteBucketMetadataConfigurationRequest
	if req.ContentLength > 0 {
		if err := json.NewDecoder(req.Body).Decode(&input); err != nil {
			writeError(w, http.StatusBadRequest, "InvalidParameterValue", fmt.Sprintf("Invalid JSON: %v", err))
			return
	...
	// Call API
	output, err := r.api.DeleteBucketMetadataConfiguration(req.Context(), &input)
	if err != nil {
		writeAPIError(w, err)
		return
	}
...
// handleGetBucketMetadataConfiguration handles the GetBucketMetadataConfiguration operation
func (r *Router) handleGetBucketMetadataConfiguration(w http.ResponseWriter, req *http.Request) {
	// Parse input
	var input GetBucketMetadataConfigurationRequest
	if req.ContentLength > 0 {
		if err := json.NewDecoder(req.Body).Decode(&input); err != nil {
			writeError(w, http.StatusBadRequest, "InvalidParameterValue", fmt.Sprintf("Invalid JSON: %v", err))
			return
	...
	// Call API
	output, err := r.api.GetBucketMetadataConfiguration(req.Context(), &input)
	if err != nil {
		writeAPIError(w, err)
		return
	}
...
// handleUpdateBucketMetadataInventoryTableConfiguration handles the UpdateBucketMetadataInventoryTableConfiguration operation
func (r *Router) handleUpdateBucketMetadataInventoryTableConfiguration(w http.ResponseWriter, req *http.Request) {
	// Parse input
	var input UpdateBucketMetadataInventoryTableConfigurationRequest
	if req.ContentLength > 0 {
		if err := json.NewDecoder(req.Body).Decode(&input); err != nil {
			writeError(w, http.StatusBadRequest, "InvalidParameterValue", fmt.Sprintf("Invalid JSON: %v", err))
			return
	...
	// Call API
	output, err := r.api.UpdateBucketMetadataInventoryTableConfiguration(req.Context(), &input)
	if err != nil {
		writeAPIError(w, err)
		return
	}
...
// handleUpdateBucketMetadataJournalTableConfiguration handles the UpdateBucketMetadataJournalTableConfiguration operation
func (r *Router) handleUpdateBucketMetadataJournalTableConfiguration(w http.ResponseWriter, req *http.Request) {
	// Parse input
	var input UpdateBucketMetadataJournalTableConfigurationRequest
	if req.ContentLength > 0 {
		if err := json.NewDecoder(req.Body).Decode(&input); err != nil {
			writeError(w, http.StatusBadRequest, "InvalidParameterValue", fmt.Sprintf("Invalid JSON: %v", err))
			return
	...
	// Call API
	output, err := r.api.UpdateBucketMetadataJournalTableConfiguration(req.Context(), &input)
	if err != nil {
		writeAPIError(w, err)
		return
	}
